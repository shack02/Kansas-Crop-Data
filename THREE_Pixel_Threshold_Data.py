...
def extract_pixel_threshold_data3(county_csv, years, year):
    ...
    print(yearly_value_per_threshold[necessary_csv.index(r"Soybeans County CSVs/OTHER (COMBINED) COUNTIES.csv")])
    ...
    for county in county_csv:
        if county not in necessary_csv:
            ...
            for i in range(101):
                ...
                yearly_value_per_threshold[necessary_csv.index(r"Soybeans County CSVs/OTHER (COMBINED) COUNTIES.csv")][i] +=\
                list[i]
...
def extract_pixel_threshold_data(county_csv, years, year):
    ...
    full_county = []
    for county in county_csv:
        full_county.append(county[21:-4])
    ...
    for county in counties_with_data:
        new_csv = "Soybeans County CSVs/" + county + ".csv"
